...
<div id="menu-image">
	...
	<img src="<?php bloginfo('template_directory'); ?>/images/bloodymary.jpg" alt="nanjing food">
	...
	<div id="menu-content">
		  ...
		  <div id="tabs">
			  ...
			  <ul>
				...
				<li><a href="#tabs-7">Lamb &amp; Duck</a></li>
				<li><a href="#tabs-8">Seafoood</a></li>
				<li><a href="#tabs-9">Tandoor</a></li>
  ...
  <div id="tabs-2" class="row">
    ...
    <div id="appetizers" class="col-md-6">
		...
		<span class="menu-item">Samosas 6</span>
		<i>Puff pastry with a savory filling such as spiced potatoes, onions, peas and lentils</i>
		<span class="menu-item">Aloo Papdi Chaat 7</span>
		<i>A mixture of wheat crisps, potatoes and chickpeas in yogurt and tamarind sauce.</i>
		<span class="menu-item">Paneer Pakora 7</span>
		<i>Homemade cottage cheese cubes dipped in gram flour and fried.</i>
		<span class="menu-item">Samosa Chaat 8</span>
		<i>Served with chick peas, yogurt, tamarind and cilantro chutneys.</i>
		<span class="menu-item">Ragda Patties  8</span>
		<i>Potato patties seasoned with herbs and served on a bed of spiced chick peas.</i>
		<span class="menu-item">Soyabean Kebab  9</span>
		<i>Shallow fried Soybean chunks mixed with bean curd, tapioca &amp; herbs spices.</i>
		<span class="menu-item">Palak Kebab  9</span>
	...
	<div id="appetizers" class="col-md-6">
      <h2>Appetizers - Non - Vegetarian</h2>
       <span class="menu-item">Dumpling </span>
		...
		<span class="menu-item">Spring Roll Fried (veg 7  Chicken 8 )</span>
		<span class="menu-item">Crispy Chicken with Honey and Dried Chilies 8</span>
		<i>sauteed in chili honey sauce.</i>
		<span class="menu-item">Chicken Satee  9</span>
		<i>Chicken on Skewer delicately cooked on griddle served with peanut sauce.</i>
		<span class="menu-item">Nanjing Heaven  11 </span>
		<i>Drums of heaven with chilies and garlic, wok fried in chili sauce.</i>
		<span class="menu-item">Grilled Tilapia 12 </span>
		<i>Served with hot chili garlic sauce </i> 
		<span class="menu-item">Grilled Garlic Shrimp 12</span>
		<i>Marinated chili and garlic shrimps served on a skewer.</i>
		<span class="menu-item">Salt &amp; Pepper Calamari  12</span>
		<i>Garlic, Ginger, Peppers, onions &amp; cilantro in black pepper with salt.</i>
		<span class="menu-item">Nanjing Combo Platter Non-vegetarian 29</span>
		<i>Lamb chops, chicken satee, Malai kabab, kabab, fish Tikka.</i>
	</div>
...
<!-- Lamb & Goat -->
	<div id="tabs-6">
		...
		<h2>Lamb &amp; Goat 23</h2>
			...
			<span class="menu-item">Lamb Or Goat Vindaloo </span>
			<i>spicy Delicacy prepared with crushed peppers and dry kashmiri Chilies and Cooked with wine-vinegar.</i>
			<span class="menu-item">Lamb Or Goat Korma </span>
			<i>In A Spiced Vinaigrette Curry.</i>
			<span class="menu-item">Lamb Or Saag Gosht </span>
			<i> In A Mild Mughlai Curry.</i>
			<span class="menu-item">Lamb Or Goat Achari </span>
			<i>Spiced Goat Or Lamb Simmered With Onion Seeds</i>
			<span class="menu-item">Lamb Or Goat Rogan Josh</span>
...
<div id="tabs-13">
	...
	<button class="btn btn-warning">Downlaod</button></a>
</div>
